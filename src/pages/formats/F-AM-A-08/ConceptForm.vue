  ...
  setup() {
    ...
    return {
      ...
      conceptConfig: {
        ...
        desfavorable: ['<', 59.9],
        mensaje: `En caso que uno o más de los aspectos a evaluar sea identificado
        como crítico y calificado como Inaceptable (I), independiente del porcentaje
        de cumplimiento obtenido, el CONCEPTO SANITARIO a emitir será DESFAVORABLE y
        se procederá a aplicar la MEDIDA SANITARIA DE SEGURIDAD respectiva.`
      }
    }
  }
})
