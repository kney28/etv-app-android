...
export const config: Config = {
  formatName: 'F-AM-A-10',
  dynamicComponent: 'FAMA10',
  headerTitle: 'Formato F-AM-A-10',
  headerContent: `Acta de inspeccion sanitaria con enfoque de riesgo para vehiculos
